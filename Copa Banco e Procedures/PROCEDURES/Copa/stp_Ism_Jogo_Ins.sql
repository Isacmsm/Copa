...
-- Descrição: Inserir Registros da Tabela Ism_Jogo
-- ============================================


CREATE OR ALTER PROCEDURE [dbo].[stp_Ism_Jogo_Ins] (
	@idJogo INT = NULL,
	@idTime1 INT = NULL,
	@idTime2 INT = NULL,
...
BEGIN
	BEGIN TRY
		...
		END
			...
			INSERT Ism_Jogo (idTime1, idTime2, DataInicio, DataFinal)
			VALUES (@idTime1, @idTime2, @DataHoraInicio, @DataHoraFinal)
		RETURN 0
	END TRY
	BEGIN CATCH
